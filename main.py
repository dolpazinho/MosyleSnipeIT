...
# Set the credentials for the Mosyle Api
mosyle = Mosyle(config['mosyle']['access_token'], config['mosyle']['url'], config['mosyle']['user'], config['mosyle']['password'])
